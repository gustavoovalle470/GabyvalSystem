...
public class StaffBean implements Serializable{
     ...
     * @return HashMap<String, Integer> all genders allowed.
     */
     ...
     * @param genders HashMap<String, Integer> the new genders allowed.
     */
     ...
     * @return HashMap<String, Integer> the ID Type allowed.
     */
     ...
     * @param id_types HashMap<String, Integer>  the new ID types allowed.
     */
