...
public class UserProfileBean implements Serializable{
     ...
     * @return HashMap<String, Integer> the all allowed status.
     */
     ...
     * @param possibleStatus HashMap<String, Integer> the new allowed status.
     */
     ...
     * @return List<AdUserProfile> all Security profile
     */
