...
public class GB_IOController {
     ...
     * @return HasMap<String, String> the mapping information.
     */
     ...
     * Load any file. 
     * @param file_path String the path of file to read.
     * @return ArrayList<String> the lines in the file.
     */
     ...
     * @param file_path String the path of file to write.
     * @param content HasMap<String, String>the mapping configuration.
